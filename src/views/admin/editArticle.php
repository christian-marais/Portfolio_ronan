    ...
    <div class=" row"> 
      <form class="cards col-11 " method="POST" enctype="multipart/form-data">
        ...
        <div class="col-12 mb-3 mt-3">
          ...
          <textarea name="description_article" class="form-control" id="Description" rows="10" placeholder="Description" required><?=$article['description_article']?></textarea>
        </div>
        ...
        <div class="mb-3">
          <h3>
            Importer le fichier image (.jpg &lt;100ko)
          </h3>
